...
class Book(models.Model):
    ...
    isbn = models.CharField(max_length=20, verbose_name="ISBN number og the book")
...
class BookContributor(models.Model):
    ...
    role = models.CharField(
        verbose_name="The role this contributor had in this book.",
...
class Review(models.Model):
    ...
    book = models.ForeignKey(
        Book, on_delete=models.CASCADE, help_text="The Book that this review was for."
    )
